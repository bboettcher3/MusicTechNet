...
// }, app);
var server = require('http').createServer(app); //creates an HTTPS server instance
...
var mongoURI = "mongodb://127.0.0.1:27017/TuneInDatabase";
var mongoDB = mongoose.connect(mongoURI, { useNewUrlParser: true });
